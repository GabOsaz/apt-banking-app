...
function Main() {
    ...
    const NavItem = ({ navItem, navIndex }) => {
        const classes = `
          px-2 sm:px-6 justify-center sm:justify-start py-3 rounded-full flex cursor-pointer
            ...
            <div className="bg-white w-4/5 h-full rounded-2xl flex"> 
                ...
                >
                    <div>
                        ...
                        {isSidebarOpen ?
                        <div className='mt-16 bg-blue-100 cursor-pointer bg-opacity-70 rounded-3xl w-11/12 py-4 px-5 text-dark text-opacity-80 font-bold flex items-center space-x-5'>
                        ...
                        <div className='flex justify-between items-center space-x-4 mt-32 w-full'>
                            <div className={` ${isSidebarOpen ? 'flex' : 'hidden'}  space-x-2 items-center`}>
                            ...
                            <span className='text-dark text-opacity-40 font-bold'>
                                <HiChevronUp />
                            </span>
                        </div>
                    </div>
